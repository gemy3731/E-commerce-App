...
export default function Register() {
  ...
  return (
    ...
    <form onSubmit={formik.handleSubmit} >
      ...
      {formik.errors.name && formik.touched.name&& (<div className=' bg-red-700 font-medium text-white p-3 rounded-lg mb-4'><h2 >{formik.errors.name}</h2></div>)}
      ...
      {formik.errors.email && formik.touched.email&& (<div className=' bg-red-700 font-medium text-white p-3 rounded-lg mb-4'><h2>{formik.errors.email}</h2> </div>)}
      ...
      {formik.errors.rePassword&& formik.touched.rePassword&& (<div className=' bg-red-700 font-medium text-white p-3 rounded-lg mb-4'><h2>{formik.errors.rePassword}</h2> </div>)}
